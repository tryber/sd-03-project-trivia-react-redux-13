      ...
      <div className="flexbox">
        <div className="uk-vertical-align-middle size">
          ...
          <form className="uk-panel uk-panel-box uk-form">
            <div className="uk-form-row">
              <input onInput={(e) => this.setState({ email: e.target.value })} data-testid="input-gravatar-email" className="uk-width-1-1 uk-form-large" type="email" placeholder="E-mail" />
            </div>

            <div className="uk-form-row">
              <input onInput={(e) => this.setState({ name: e.target.value })} data-testid="input-player-name" className="uk-width-1-1 uk-form-large" type="text" placeholder="Nome" />
            </div>
